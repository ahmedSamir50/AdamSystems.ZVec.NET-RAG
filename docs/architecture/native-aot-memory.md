...
>
> **Sample 03 MAUI:** Task 1.10.1 iOS simulator launch + GC is not run in this repo yet. Residual MonoAOT SafeHandle finalizer risk remains. Do not treat Sample 03 as iOS-certified.
